...
print(f"Chúc mừng! Bạn đã tích đủ tiền mở quán vào Ngày thứ: {day}")
print(f"Số tiền tích lũy cuối cùng: {current_cash:,.0f} VNĐ")
...
# Thêm chữ hiển thị số tiền bên cạnh ngôi sao
